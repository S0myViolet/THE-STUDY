...
export async function seedDemo(db: StudyDatabase): Promise<void> {
  ...
  for (let d = DAYS; d >= 0; d--) {
    ...
    const ds = stamp<DailySession>(db.userId, "ses", { date: day.slice(0, 10), length: "standard", items: [{ id: "a", kind: "arrival", title: "Arrival", minutes: 1, reason: "ritual", reasonText: "", href: "/v1/desk", status: "done" }, { id: "b", kind: "glance", title: "The Glance", minutes: 4, reason: "foundation", reasonText: "", href: "/v1/observation/glance", status: "done" }, { id: "c", kind: "case", title: "Case", minutes: 22, reason: "foundation", reasonText: "", href: "/v1/casebook", status: sessions.length % 2 === 0 ? "done" : "skipped" }, { id: "d", kind: "after_action", title: "After Action", minutes: 3, reason: "ritual", reasonText: "", href: "/v1/desk", status: "done" }], status: "completed", startedAt: day, completedAt: at(d, 20), currentIndex: 4 });
    ds.createdAt = day;
    ds.updatedAt = day;
